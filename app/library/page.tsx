  ...
  <div className="dashboard">
    ...
    <div className="dashboard__main">
      ...
      <div className="dashboard__content library__content">
        ...
        <p className="library__count">{books.length} {books.length === 1 ? "item" : "items"}</p>
            ...
            <Link key={book.id} href={`/book/${book.id}`}>
              ...
              <div className="libraryCard">
                ...
                <div className="libraryMeta">
                  <span className="library__icon"><FiClock /> {durations[book.id] || "..."}</span>
                  <span className="library__icon"><FiStar /> {book.averageRating}</span>
                </div>
